...
public class BitwiseOperatorDemo {
	...
	public static void main(String[] args) {
		...
		// (>>>) unsigned right shift operator will fill with 0 on the left, no matter whether the higher order bit is 0 or 1
		// (>>) signed right shift operator will fill with whatever is the higher order bit on the left
